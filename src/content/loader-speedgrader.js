...
import { initializeLimits, touchMeta, pruneSavedPoints, normalizeMetaKeys, saveStudentNamesWithPrune, CSHStorageUtils } from '../shared/storage-utils.js';
    ...
    if (msg.type === CSH_MESSAGE_TYPES.SAVE_STUDENT_NAME) {
      ...
      chrome.storage.local.get({ studentNames: {}, studentNamesMeta: { lastUsed: {} } }, (data) => {
        ...
        const touched = storageUtils
          ? touchMeta(currentMeta, [studentId])
          : currentMeta;

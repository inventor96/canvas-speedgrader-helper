...
- **Automatically click "Load Queue" when the current queue is empty**: When you reach the end of the queue and no items are visible, the extension automatically clicks the `Load Queue` button to fetch more submissions.
